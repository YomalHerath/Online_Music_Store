<html>
    ...
    <table width='80%' border= 1 style="background-color:rgba(255, 255, 255,0.6);">
        ...
        <tr><th colspan ="9" align = "center" style="background-color:rgba(0, 0, 255, 0.3);"><h2>Artist Details</h2></th></tr>
    ...
    ?>
        ...
        <tr>
           ...
           <td>
           <?php echo $row['picture']; ?></td>
           <?php   
            echo "<td><a href=\"edit_artist.php?id=$row[id]\">Edit</a> |
            <a href=\"delete_artist.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete
            </a></td></tr>"; 
            ?>
        </tr>
    <?php   
